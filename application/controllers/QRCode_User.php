...
class QRCode_User extends AUTH_Controller
{
	...
	public function index()
	{
		...
		$data['dataQRCode'] = $this->M_qrcode->select_by_user();
		...
		$data['dataSertifikatUser'] = $this->M_sertifikat->select_by_user();
		$data['dataLabel'] = $this->M_label->select_all();

		$data['modal_tambah_qrcode_user'] = show_my_modal('modals/modal_tambah_qrcode_user', 'tambah-qrcode-user', $data);

		$this->template_user->views('qrcode_user/home', $data);
	...
	public function tampil()
	{
		...
		$this->load->view('qrcode_user/list_data', $data);
	}
	...
	public function prosesTambah()
	{
		...
		// 	$volume_awal = $data['volume'];
		// 	$volume_sebelum = $dataQrcode->volume;

		// 	if ($result > 0) {
		// 		if ($data['volume'] == $volume_sebelum) {
		// 			$out['status'] = '';
		// 			$out['msg'] = show_succ_msg('QR Code Berhasil dicetak', '20px');
		// 		} else {
		// 			$out['status'] = '';
		// 			$out['msg'] = show_err_msg('QR Code Tidak Berhasil dicetak COY', '20px');
		// 		}
		// 	} else {
		// 		$out['status'] = '';
		// 		$out['msg'] = show_err_msg('QR Code Tidak Berhasil dicetak', '20px');
