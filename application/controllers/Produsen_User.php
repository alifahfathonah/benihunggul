...
class Produsen_User extends AUTH_Controller
{
	...
	public function index()
	{
		...
		$data['dataProdusen'] = $this->M_produsen->select_by_user();
		...
		$this->template_user->views('produsen_user/home', $data);
	...
	{
		$data['dataProdusen'] = $this->M_produsen->select_by_user();
		$this->load->view('produsen_user/list_data', $data);
	}
	...
	public function update()
	{
		...
		echo show_my_modal('modals/modal_update_produsen_user', 'update-produsen-user', $data);
	}
