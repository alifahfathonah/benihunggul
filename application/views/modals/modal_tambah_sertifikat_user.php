<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <form id="form-tambah-sertifikat-user" method="POST">
    <table class="table table-striped">
      ...
      <tr>
        ...
        <td>:</td>
        <td> <?php echo combo_box_data_w_name($dataSemuaSertifikat, 'id_sertifikat', 'sert_sumber_benih', 'no_sertifikat'); ?></td>
      ...
      <tr>
        ...
        <td>Pemilik</td>
        <td>:</td>
        <td> <?php echo combo_box_data_produsen($dataProdusenUser, 'id_produsen', 'nama_perusahaan', 'nama_perusahaan'); ?></td>
        <!-- <td> <input type="text" class="form-control" placeholder="Nomor Sertifikat" name="no_sertifikat" aria-describedby="sizing-addon2" value="<?php echo $dataSemuaSertifikat->no_sertifikat; ?>" disabled="disabled"></td> -->
