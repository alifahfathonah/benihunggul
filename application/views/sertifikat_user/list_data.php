...
foreach ($dataSertifikat as $sertifikat) {
  ...
  <tr>
    ...
    <td class="text-center" style="min-width:230px;">
      <button class="btn btn-warning update-dataSertifikat-user" data-id="<?php echo $sertifikat->id_sertifikat; ?>"><i class="glyphicon glyphicon-edit"></i></button>
      <button class="btn btn-danger konfirmasiHapus-sertifikat-user" data-id="<?php echo $sertifikat->id_sertifikat; ?>" data-toggle="modal" data-target="#konfirmasiHapus"><i class="glyphicon glyphicon-remove-sign"></i></button>
