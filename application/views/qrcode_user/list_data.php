...
<tr>
    ...
    <td class="text-center" style="min-width:150px;">
        <button class="btn btn-danger konfirmasiHapus-qrcode-user" data-id="<?php echo $qrcode->id_qrcode; ?>" data-toggle="modal" data-target="#konfirmasiHapus"><i class="glyphicon glyphicon-remove-sign"></i></button>
